...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2025 a las 07:46:05
...
--
-- Estructura de tabla para la tabla `eps_emails`
--

CREATE TABLE `eps_emails` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `eps_emails`
--

INSERT INTO `eps_emails` (`id`, `eps_id`, `email`, `estado`, `fecha_creacion`) VALUES
(1, 1, 'auditorias_boyaca@nuevaeps.com.co', 1, '2025-07-02 04:16:45'),
(2, 2, 'notificajudiciales@keralty.com', 1, '2025-07-02 04:17:12'),
(3, 3, 'notificaciones@famisanar.com.co', 1, '2025-07-02 04:17:46'),
(4, 4, 'rurodriguez@coosalud.com', 1, '2025-07-02 04:18:27'),
(5, 5, 'leydi.gutierrez@cajacopieps.com', 1, '2025-07-02 04:19:00'),
(6, 6, 'crisgacovi@gmail.com', 1, '2025-07-02 04:23:17'),
(7, 6, 'crisgacovi@hotmail.com', 1, '2025-07-02 04:23:17');
...
(1, 'Paula Baron', '1049606165', 'crisgacovi@yahoo.com', '', 13, 6, 3, 'No me asignaron cita', 'Se ha remitido la solicitud a su EPS, pronto se comunicarán con usted', NULL, '2025-07-02', '2025-07-02 05:26:58', 'En Proceso', NULL, 1);
...
--
-- Indices de la tabla `eps_emails`
--
ALTER TABLE `eps_emails`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_eps_email` (`eps_id`,`email`);
...
--
-- AUTO_INCREMENT de la tabla `eps_emails`
--
ALTER TABLE `eps_emails`
...
--
-- Filtros para la tabla `eps_emails`
--
ALTER TABLE `eps_emails`
  ADD CONSTRAINT `eps_emails_ibfk_1` FOREIGN KEY (`eps_id`) REFERENCES `eps` (`id`) ON DELETE CASCADE;
